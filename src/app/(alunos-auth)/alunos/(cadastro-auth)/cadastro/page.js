        ...
        <main className={`${poppins.className} ${styles.Main}`}>
            ...
            <div className={styles.containerInfos}>
                ...
                <div className={styles.inputsAluno}>
                    ...
                    <InputsCadastro name='Sexo' editAluno={true} length='small' type='select' select='sexo' value={formData['gender']} onChange={(e) => handleInputChange('gender', e.target.value)} style={{ border: ` 2px solid ${validateInput('gender', formData['gender'])}` }} />
                    ...
                    <InputsCadastro name='Horario' editAluno={true} type='select' select='horario' value={formData['schedule']} onChange={(e) => handleInputChange('schedule', e.target.value)} style={{ border: ` 2px solid ${validateInput('schedule', formData['schedule'])}` }} />
                    <InputsCadastro name='Modalidade' editAluno={true} type='select' select='modalidade' value={formData['modality']} onChange={(e) => handleInputChange('modality', e.target.value)} style={{ border: ` 2px solid ${validateInput('modality', formData['modality'])}` }} />
                </div>
            </div>
            <hr></hr>
